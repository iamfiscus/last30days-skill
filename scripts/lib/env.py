...
def get_config() -> Dict[str, Any]:
    ...
    config = {
        ...
        'PARALLEL_API_KEY': os.environ.get('PARALLEL_API_KEY') or file_env.get('PARALLEL_API_KEY'),
        'BRAVE_API_KEY': os.environ.get('BRAVE_API_KEY') or file_env.get('BRAVE_API_KEY'),
